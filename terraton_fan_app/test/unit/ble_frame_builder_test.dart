...
void main() {
  ...
  // Speed frames: [0x55, 0xAA, 0x06, 0x04, 0x01, N, (0x06+0x04+0x01+N)&0xFF]
  test('setSpeed(1)', () => expect(BleFrameBuilder.setSpeed(1), [0x55, 0xAA, 0x06, 0x04, 0x01, 0x01, 0x0C]));
  test('setSpeed(2)', () => expect(BleFrameBuilder.setSpeed(2), [0x55, 0xAA, 0x06, 0x04, 0x01, 0x02, 0x0D]));
  test('setSpeed(3)', () => expect(BleFrameBuilder.setSpeed(3), [0x55, 0xAA, 0x06, 0x04, 0x01, 0x03, 0x0E]));
  test('setSpeed(4)', () => expect(BleFrameBuilder.setSpeed(4), [0x55, 0xAA, 0x06, 0x04, 0x01, 0x04, 0x0F]));
  test('setSpeed(5)', () => expect(BleFrameBuilder.setSpeed(5), [0x55, 0xAA, 0x06, 0x04, 0x01, 0x05, 0x10]));
  test('setSpeed(6)', () => expect(BleFrameBuilder.setSpeed(6), [0x55, 0xAA, 0x06, 0x04, 0x01, 0x06, 0x11]));
